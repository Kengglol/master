...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles Fahrzeuge die einladen koennen
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box", "C_Van_01_transport"];
	IL_Supported_Vehicles_HEMTT = ["Exile_Car_HEMMT","B_Truck_01_transport","B_Truck_01_covered", "B_Truck_01_mover", "B_Truck_01_box"];
	IL_Supported_Vehicles_KAMAZ = ["Exile_Car_Zamak","I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	IL_Supported_Vehicles_TEMPEST = ["Exile_Car_Tempest","O_Truck_02_covered", "O_Truck_02_transport","O_Truck_03_covered","O_Truck_02_box"];
	IL_Supported_Vehicles_MOHAWK = ["Exile_Chopper_Mohawk_FIA","I_Heli_Transport_02"];
	IL_Supported_Vehicles_CHINOOK = ["B_Heli_Transport_03_unarmed", "CH_147F", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base","B_Heli_Transport_03_unarmed"];
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01","mosquito"];
	...
	//Supported cargo Hier deine Mission Kisten oder sonstiges eintragen was geladen werden kann
	IL_Supported_HEMTT = 	["B_Truck_01_transport","B_Truck_01_covered", "B_Truck_01_mover", "B_Truck_01_box"];
	IL_Supported_KAMAZ = 	["I_Truck_02_transport","O_Truck_02_transport", "I_Truck_02_covered", "O_Truck_02_covered", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	IL_Supported_TEMPEST = 	["O_Truck_02_covered","O_Truck_02_transport"];
	IL_Supported_Strider = 	["I_MRAP_03_F","Exile_Car_Strider"];
	IL_Supported_Hunter = 	["B_MRAP_01"];
	...
	IL_Supported_VAN = 		["C_Van_01_box", 			"C_Van_01_transport"];
	IL_Supported_OFFROAD = 	["C_Offroad_01", "Exile_Car_Offroad_Red","O_G_Offroad_01_armed_F"];
	IL_Supported_SUV = 		["C_SUV_01"];
	IL_Supported_Hatchback = ["C_Hatchback_01", 		"C_Hatchback_02"];
	...
	IL_Supported_Quadbike = ["ebike", 				"C_Quadbike_01","K01","K02","K03","K04"];
	...
	IL_Supported_Rubberboat = ["C_Rubberboat", 		"C_Rubberboat_02","C_Rubberboat_03","C_Rubberboat_04","C_Boat_Civil_01", "C_Boat_Civil_01_police", "C_Boat_Civil_01_rescue"];
	IL_Supported_SDV = 		["I_SDV_01_F", 					"O_SDV_01_F", "B_SDV_01", "B_mas_mar_SDV_01_F"];
	...
	IL_Supported_Cargobox = ["I_CargoNet_01_ammo_F","O_CargoNet_01_ammo_F","B_CargoNet_01_ammo_F","I_supplyCrate_F","Box_East_AmmoVeh_F","Box_NATO_AmmoVeh_F","Land_Pod_Heli_Transport_04_bench_F", "Land_Pod_Heli_Transport_04_covered_F", "Land_Pod_Heli_Transport_04_box_F", "JNS_SkycranePod_Bench", "JNS_SkycranePod_Transport", "JNS_SkycranePod_Cargo", "Land_Pod_Heli_Transport_04_Black_bench_F", "Land_Pod_Heli_Transport_04_Black_covered_F", "Land_Pod_Heli_Transport_04_Black_box_F"];
	IL_Supported_MH9 = ["B_Heli_Light_01"];
	IL_Supported_jetski = ["jetski"];
	IL_Supported_mosquito = ["mosquito"];
	...
	IL_Supported_Cargo_Veh_HEMTT = 			IL_Supported_Cargo_Veh_Kamaz + 		IL_Supported_OFFROAD + 	IL_Supported_Strider +		IL_Supported_SUV;
